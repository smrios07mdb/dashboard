...
| 10 | Routines tab | dashboard | ☑ | Claude Code | d50b8e7 | — | Sample data seeds routine_items with created_at = now(); per ARCH §11 the backdated logs cover non-required items and Test 7 reads streak = 0. Flagged as Revisions chunk-6 follow-up. |
