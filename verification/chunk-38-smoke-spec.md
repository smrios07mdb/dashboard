...
**Runs:** two, both in `verification/chunk-38-smoke.md` — checks 6–10 (current week, Sunday, top section) and checks 1–5 on a future week (`# Re-run (checks 1–5, 2026-08-30)` section). Check 1's today-relative cursor branch remains for a Mon–Thu run.
