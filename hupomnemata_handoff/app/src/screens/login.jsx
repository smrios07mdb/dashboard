      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ marginBottom: 32, textAlign: 'center' }}>
          <div className="display" style={{
            fontSize: 38, fontWeight: 500, letterSpacing: '-.025em',
            color: 'var(--ink)',
            display: 'inline-flex', alignItems: 'baseline', gap: 1,
          }}>
            <span>hupomnemata</span>
            <span style={{ color: 'var(--work)', fontWeight: 500 }}>.</span>
          </div>
          <div className="label" style={{ marginTop: 14, fontSize: 9 }}>
            <span style={{ color: 'var(--ink-3)', letterSpacing: '.22em' }}>PERSONAL · QUIET · YOURS</span>
          </div>
        </div>

        <div style={{
          background: 'var(--surface)', border: '1px solid var(--line)',
          borderRadius: 'var(--radius-lg)', padding: '30px 30px 26px',
          boxShadow: 'var(--shadow-md)',
        }}>

        {!sent ? (
          <React.Fragment>
            <h1 className="display" style={{ margin: 0, fontSize: 27, fontWeight: 500, letterSpacing: '-.01em', color: 'var(--ink)' }}>Sign in</h1>
          ...
          <React.Fragment>
            ...
            <h1 className="display" style={{ margin: 0, fontSize: 27, fontWeight: 500, letterSpacing: '-.01em', color: 'var(--ink)' }}>Check your email</h1>
