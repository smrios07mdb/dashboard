...
| Desktop 1440px (27" portrait) | Shell fills the window (1280px cap removed 2026-09-02); 40px side padding at ≥1024px by default, user-adjustable per device via Settings → Display → Page margins |
